...
export async function calculateBNBInvestmentInUSD(bnbAmount) {
  console.log("Calculating USD value for BNB amount:", bnbAmount);
  try {
    ...
    console.log("Currency Price:", bnbPrice);
